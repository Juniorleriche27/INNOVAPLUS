        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600">
              Choisis un module dans le menu déroulant. Tu peux consulter librement les thèmes, mais le module suivant se
              déverrouille uniquement après validation du module précédent.
            </p>
          </div>

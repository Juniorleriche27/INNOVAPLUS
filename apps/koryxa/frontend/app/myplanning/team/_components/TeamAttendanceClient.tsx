      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-700">Présence sur la période (user-days).</p>
          </div>
          <div className="flex items-center gap-2">
            <select
              value={period}
          ...
          <div className="mt-4 space-y-4">
            <div className="grid gap-3 sm:grid-cols-4">
              <div className="rounded-2xl border border-slate-200 p-4">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Taux</p>
                <p className="mt-2 text-2xl font-semibold text-slate-900">{fmtPercent(overview.present_rate)}</p>
              </div>
              <div className="rounded-2xl border border-slate-200 p-4">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Présents</p>
                <p className="mt-2 text-2xl font-semibold text-slate-900">{overview.n_present}</p>
              </div>
              <div className="rounded-2xl border border-slate-200 p-4">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Partiels</p>
                <p className="mt-2 text-2xl font-semibold text-slate-900">{overview.n_partial}</p>
              </div>
              <div className="rounded-2xl border border-slate-200 p-4">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Absents</p>
                <p className="mt-2 text-2xl font-semibold text-slate-900">{overview.n_absent}</p>
              </div>
            </div>

            <div className="rounded-2xl border border-slate-200">
              <div className="border-b border-slate-200 px-4 py-3 text-sm font-semibold text-slate-900">
                Série par jour (present/partial/absent)
              </div>
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody>
                    {overview.series.map((p) => (
                      <tr key={p.day} className="border-t border-slate-100">
                        <td className="px-4 py-3 text-slate-900">{p.day}</td>

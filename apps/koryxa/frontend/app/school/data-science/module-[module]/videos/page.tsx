...
export default function DataScienceModuleVideos({ params }: { params: { module: string } }) {
  const moduleNumber = Number.parseInt(params.module, 10);
  const meta = getModuleMeta("data-science", Number.isFinite(moduleNumber) ? moduleNumber : 1);

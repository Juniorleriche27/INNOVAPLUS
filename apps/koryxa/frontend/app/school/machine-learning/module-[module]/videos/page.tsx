...
export default function MachineLearningModuleVideos({ params }: { params: { module: string } }) {
  const moduleNumber = Number.parseInt(params.module, 10);
  const meta = getModuleMeta("machine-learning", Number.isFinite(moduleNumber) ? moduleNumber : 1);
  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
      ...
      <div className="mt-8 text-sm text-slate-600">Aucune vidéo pour le moment pour ce module.</div>

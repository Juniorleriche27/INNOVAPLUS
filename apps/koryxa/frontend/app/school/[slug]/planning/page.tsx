      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-700">Cette vue ne montre que les taches de contexte <code className="rounded bg-slate-100 px-1">learning</code>.</p>
          </div>
      ...
      <section className="space-y-3">
        ...
        {tasks.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-6 text-sm text-slate-700">
            Aucune tache pour ce parcours. Clique sur “Creer ma progression”.
          </div>
        ) : (

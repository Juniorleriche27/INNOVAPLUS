...
import { getServiceIaBySlug, SERVICE_IA_ITEMS } from "../data";
  ...
  return (
    <main className="space-y-8 pb-16">
      <section className="rounded-[30px] border border-slate-200 bg-[linear-gradient(145deg,#ffffff_0%,#f8fbff_100%)] p-6 shadow-[0_18px_46px_rgba(15,23,42,0.06)] sm:p-9">
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-[-0.04em] text-slate-950 sm:text-4xl">{service.title}</h1>

...
export default function FondamentauxPage() {
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
      <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Parcours fondamentaux</p>
      ...
      <Link href="/school/parcours/fondamental" className="btn-primary mt-6 inline-flex">

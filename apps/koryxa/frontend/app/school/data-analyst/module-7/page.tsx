...
export default function DataAnalystModule7Placeholder() {
  ...
  if (!module1Completed) {
    return (
      <section className="rounded-3xl border border-amber-200 bg-amber-50 p-8 text-sm text-amber-800">
        Module 7 verrouille. Valide d'abord le Module 1 (notebooks + quiz).
        <div className="mt-4">
  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
      <h1 className="text-2xl font-semibold text-slate-900">Module 7 — Recommandations + capstone</h1>

...
Input: JSONL at INNOVAPLUS/INNOVA/training/data/sft_qa/train.jsonl where each line has either:
...
def main():
    ...
    ap.add_argument("--output_dir", default="INNOVAPLUS/INNOVA/training/models/chatlaya-lora")

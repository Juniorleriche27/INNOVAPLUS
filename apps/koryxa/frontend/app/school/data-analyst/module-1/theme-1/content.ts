    ...
    sections: [
      {
        ...
        body: [
          ...
          "L’objectif n’est pas de produire des chiffres. L’objectif est de réduire l’incertitude qui bloque une action. Par exemple :",
          ...
          "Piège B — “On ne sait pas qui est le vrai client”. Le demandeur n’est pas toujours celui qui décide. Une personne peut demander une analyse, mais la décision finale appartient à une autre. Si tu travailles uniquement avec le demandeur, tu risques une situation très fréquente : à la fin, le décideur dit “ce n’est pas ça que je voulais”.",
          "Piège C — “On découvre les contraintes trop tard”. Tu peux produire une analyse parfaite, puis apprendre à la fin : que les données ne sont pas accessibles, que la conformité interdit un usage, que l’équipe IT ne peut pas intégrer le dashboard, que le terrain ne peut pas appliquer la recommandation. Ces contraintes auraient dû être identifiées au début avec les bonnes personnes.",
          ...
          "• “Quels modules doivent être améliorés en priorité ?”",
          "• “Pourquoi les apprenants abandonnent au thème 2 ?”",
          "• “Quel canal d’acquisition apporte les meilleurs apprenants ?”",
          "• “Quel type d’exercice augmente la réussite au mini-projet ?”",
          ...
          "Résultat 2 — Une première cartographie des parties prenantes. Tu sais : qui décide, qui utilise, qui fournit les données, qui peut bloquer, qui subit l’impact. Sans cette cartographie, tu travailles dans le noir.",
          ...
          "Avant d’ouvrir un fichier de données, tu dois pouvoir répondre :",
    ...
    sections: [
      {
        ...
        body: [
          "Beaucoup de gens pensent que la Data Analysis commence quand on récupère les données. En réalité, le vrai départ d’un projet data, c’est le problème de décision. Tant que ce problème est flou, les données ne peuvent pas “sauver” le projet. Tu peux avoir le meilleur dataset du monde : si la décision n’est pas claire, tu produiras un résultat confus, ou non actionnable.",
          ...
          "Exemples : faut-il augmenter le prix ou pas ? recruter plus de mentors ou améliorer le contenu ? cibler les campagnes sur Facebook ou sur LinkedIn ? renforcer la sécurité d’un service A ou d’un service B ? ouvrir un nouveau point de service dans telle zone ?",
          "Dans chaque cas, l’analyse sert à réduire l’incertitude : elle n’élimine pas tous les risques, mais elle rend la décision plus solide.",
          ...
          "Le besoin réel ressemble plutôt à : “Pourquoi les ventes baissent ? Quel produit doit-on mettre en avant ? Quel segment client rapporte le plus ? Quelle action marketing donne le meilleur ROI ?”",
          "Technique simple : la question “Et alors ?”",
          "Quand quelqu’un te demande un rapport, demande-toi : “Et alors, on fera quoi avec ce chiffre ?”. Si personne ne sait quoi faire avec le résultat, l’analyse n’a pas de destination.",
          "3) Formule pratique pour cadrer le problème",
          "Tu peux cadrer presque tous les projets avec une structure simple : Décision à prendre ; Objectif ; Indicateur ; Périmètre ; Contraintes ; Actions possibles (au moins deux).",
          "4) Attention : “question intéressante” ≠ “question utile”",
          "Une question peut être intéressante mais inutile si elle ne débouche sur aucune action. Une question utile ressemble plutôt à : “Quel type d’exercice réduit l’abandon après la page 3 ?” parce qu’elle permet de tester, agir, mesurer.",
          "5) Le cadrage du succès (sinon tu n’as pas de fin)",
          "Un projet data sans critère de succès est un projet qui ne finit jamais. Tu dois définir un succès mesurable, même si ce n’est pas parfait (ex : réduire le temps d’attente moyen de 15% en 2 mois).",
          "6) Exemple municipal (service public, file d’attente)",
          "Demande : “Analyse la situation des points d’eau.” Besoin décisionnel : décider où intervenir en priorité. Indicateurs : temps d’attente, % de jours en panne, nombre d’usagers impactés. Contraintes : budget limité, délais courts. Actions : réparer, installer un nouveau point, renforcer la maintenance, redistribuer l’accès.",
          "7) Le livrable attendu de cette page",
          "Format recommandé (7 lignes) : Contexte ; Décision ; Objectif ; Indicateur(s) ; Périmètre ; Contraintes ; Actions envisagées (A/B/C).",
          "Exercice rapide : choisis un sujet (formation, commerce, municipal, santé) et écris ton problème en 7 lignes avec ces champs.",
        ],
      },
    ],
  },

...
export default function DataEngineerModuleVideos({ params }: { params: { module: string } }) {
  const moduleNumber = Number.parseInt(params.module, 10);
  const meta = getModuleMeta("data-engineer", Number.isFinite(moduleNumber) ? moduleNumber : 1);
